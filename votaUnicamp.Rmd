...
pacotes = c("tm","SnowballC","wordcloud","RColorBrewer","RCurl","XML","stringr","rvest","googleVis","leaflet","pracma","dplyr","d3heatmap","RColorBrewer", "ggrepel", "ggplot2", "ggmap")
...
data.Instituto = data.frame(cbind(colnames(cursosPorInstituto),naoInstituto,totalInstituto,round(propInstituto,3)))
